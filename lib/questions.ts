...
{
  id: 13,
  text: "How do you manage technical debt?",
  options: [
    { text: "Track and pay it down regularly.", scoreModifier: { cleanCodeScore: 20 } },
    { text: "Ignore until crisis.", scoreModifier: { chaosScore: 20 } },
    { text: "Complain about it constantly.", scoreModifier: { burnoutScore: 20 } },
    { text: "Let AI refactor later.", scoreModifier: { aiDependencyScore: 15 } }
  ]
},

{
  ...
  options: [
    { text: "Elegant solutions.", scoreModifier: { cleanCodeScore: 15 } },
    { text: "Recognition and status.", scoreModifier: { egoScore: 20 } },
    { text: "Stability and low stress.", scoreModifier: { burnoutScore: 15 } },
    { text: "Automation and efficiency.", scoreModifier: { aiDependencyScore: 15 } }
  ]
},

{
  id: 15,
  text: "Your biggest weakness as a developer?",
  options: [
    { text: "Over-engineering.", scoreModifier: { cleanCodeScore: 15, egoScore: 10 } },
    { text: "Rushing fixes.", scoreModifier: { chaosScore: 20 } },
    { text: "Mental exhaustion.", scoreModifier: { burnoutScore: 20 } },
    { text: "Over-relying on AI.", scoreModifier: { aiDependencyScore: 25 } }
  ]
}
];